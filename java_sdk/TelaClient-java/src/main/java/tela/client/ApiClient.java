...
import tela.client.auth.Authentication;
import tela.client.auth.HttpBasicAuth;
import tela.client.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  private String basePath = "http://27.111.216.231:8000/v1/token_fire";
