...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://27.111.216.231:8000/v1/token_fire';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-Tela" by default
     *
     * @var string
     */
    protected $userAgent = "PHP-Tela/1.0.0";
    ...
    {
        $report  = "PHP SDK (Tela\Client) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    Tela Spec Version: 0.1.0\n";
